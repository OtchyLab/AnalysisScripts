...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    plot(10:5:400, preYmean, 'LineWidth', 2, 'DisplayName', 'Pre')
    hold on
    plot(10:5:400, inactYmean, 'LineWidth', 2, 'DisplayName', 'Inact')
    plot(10:5:400, PBSYmean, 'LineWidth', 2, 'DisplayName', 'PBS')
    plot(10:5:400, elevYmean, 'LineWidth', 2, 'DisplayName', 'Elev')
    plot(10:5:400, postYmean, 'LineWidth', 2, 'DisplayName', 'Post')
...
saveName = 'Summary Inactivation Data 04282015';
