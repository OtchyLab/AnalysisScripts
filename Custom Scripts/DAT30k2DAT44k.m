function [DATname,DAT] = DAT30k2DAT44k(fullFilename)
...
%modern DAT format. The function returns both the reconstructed DAT and the updated filename.
%
...
fs = 30030; %Hardcode this for now as many of the headers are incorrect.
...
%Up-sample the data from 30.03kHz to 44.15kHz
ratio = 44150/30030;
data = interp1(1:size(channels,2), channels',linspace(1,size(channels,2),floor(ratio*size(channels,2))),'v5cubic')';
