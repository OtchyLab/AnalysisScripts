...
for j=1:length(listD)
     AvesU.(genvarname(['AveFR' int2str((j))])) = [];
     AvesU.(genvarname(['BurstFraction' int2str((j))])) = [];
     AvesU.(genvarname(['Sparseness' int2str((j))])) = [];
     AvesU.(genvarname(['ISI' int2str((j))])) = [];
     AvesD.(genvarname(['AveFR' int2str((j))])) = [];
     AvesD.(genvarname(['BurstFraction' int2str((j))])) = [];
     AvesD.(genvarname(['Sparseness' int2str((j))])) = [];
     AvesD.(genvarname(['ISI' int2str((j))])) = [];
end
...
for i=1:length(Syls)
 ...
 for j=1:length(listD)
     ...
     for i=1:length(Syls)
        ...
        AvesD.(genvarname(['AveFR' int2str((j))])) = [AvesD.(genvarname(['AveFR' int2str((j))])); eval([CurFileD '.AveFR' int2str(Syls(i))])];
        ...
        AvesD.(genvarname(['BurstFraction' int2str((j))])) = [AvesD.(genvarname(['BurstFraction' int2str((j))])); eval([CurFileD '.BurstFraction' int2str(Syls(i))])];
        ...
        AvesD.(genvarname(['Sparseness' int2str((j))])) = [AvesD.(genvarname(['Sparseness' int2str((j))])); eval([CurFileD '.Sparseness' int2str(Syls(i))])];
        ValsD.(genvarname(['ISI' int2str(Syls(i))])) = [ValsD.(genvarname(['ISI' int2str(Syls(i))])); eval([CurFileD '.ISI' int2str(Syls(i))])];
        AvesD.(genvarname(['ISI' int2str((j))])) = [AvesD.(genvarname(['ISI' int2str((j))])); eval([CurFileD '.ISI' int2str(Syls(i))])];

        ValsU.(genvarname(['AveFR' int2str(Syls(i))])) = [ValsU.(genvarname(['AveFR' int2str(Syls(i))])); eval([CurFileU '.AveFR' int2str(Syls(i))])];
        AvesU.(genvarname(['AveFR' int2str((j))])) = [AvesU.(genvarname(['AveFR' int2str((j))])); eval([CurFileU '.AveFR' int2str(Syls(i))])];
        ...
        AvesU.(genvarname(['BurstFraction' int2str((j))])) = [AvesU.(genvarname(['BurstFraction' int2str((j))])); eval([CurFileU '.BurstFraction' int2str(Syls(i))])];
        ...
        AvesU.(genvarname(['Sparseness' int2str((j))])) = [AvesU.(genvarname(['Sparseness' int2str((j))])); eval([CurFileU '.Sparseness' int2str(Syls(i))])];
        ValsU.(genvarname(['ISI' int2str(Syls(i))])) = [ValsU.(genvarname(['ISI' int2str(Syls(i))])); eval([CurFileU '.ISI' int2str(Syls(i))])];
        AvesU.(genvarname(['ISI' int2str((j))])) = [AvesU.(genvarname(['ISI' int2str((j))])); eval([CurFileU '.ISI' int2str(Syls(i))])];
     end
 end

 for j=1:length(listD)
     MeanAveFRD(j) = mean(AvesD.(genvarname(['AveFR' int2str((j))]))(~isnan(AvesD.(genvarname(['AveFR' int2str((j))])))));
     MeanBurstFractionD(j) = mean(AvesD.(genvarname(['BurstFraction' int2str((j))]))(~isnan(AvesD.(genvarname(['BurstFraction' int2str((j))])))));
     MeanSparsenessD(j) = mean(AvesD.(genvarname(['Sparseness' int2str((j))]))(~isnan(AvesD.(genvarname(['Sparseness' int2str((j))])))));
     
     MeanAveFRU(j) = mean(AvesU.(genvarname(['AveFR' int2str((j))]))(~isnan(AvesU.(genvarname(['AveFR' int2str((j))])))));
     MeanBurstFractionU(j) = mean(AvesU.(genvarname(['BurstFraction' int2str((j))]))(~isnan(AvesU.(genvarname(['BurstFraction' int2str((j))])))));
     MeanSparsenessU(j) = mean(AvesU.(genvarname(['Sparseness' int2str((j))]))(~isnan(AvesU.(genvarname(['Sparseness' int2str((j))])))));
 end
