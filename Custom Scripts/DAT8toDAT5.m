function [filename, DAT] = DAT8toDAT5(fullFilename)
%This function takes as input the full filename (i.e., absolute path +
%filename) for a 8-channel DAT file and convertas it to the standard 5-channel DAT structure.
...
for i=1:numChan
   ...
   data(i,:) = [chunks(i,:), MultiPlexed(i:8:end)'];  %Correction for 8-chan mistake
end
fid = fclose('all');
