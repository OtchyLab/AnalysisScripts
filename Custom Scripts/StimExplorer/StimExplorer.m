...
% Last Modified by GUIDE v2.5 13-Mar-2018 15:31:15
...
%Constants
handles.fs = 44150;
handles.formatIn = 'yyyy-mm-dd HH:MM';
...
cla(handles.axes_stim);
cla(handles.axes_nostim);
cla(handles.axes_diff);
linkaxes([handles.axes_stim,handles.axes_nostim,handles.axes_diff],'off')
...
linkaxes([handles.axes_stim,handles.axes_nostim,handles.axes_diff],'xy')
...
linkaxes([handles.axes_stim,handles.axes_nostim,handles.axes_diff],'x')
linkaxes([handles.axes_stim,handles.axes_nostim],'y')
...
function check_incAll_Callback(hObject, eventdata, handles)
