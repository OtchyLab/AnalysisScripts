...
%                 end;
                ...
                set(gcf, 'Units', 'inches', 'Position', [4, 1, 5, 8])
...
set(gcf, 'Units', 'inches', 'Position', [1, 3, 5, 10])
drawnow
...
%Tutored
sp_Mean = [29.5, 49.6, 73.6, 79.1]./1000;
sp_Std  = [21.7, 30.1, 60.4, 43.6]./1000;
sp_rawPrun = [18.7, 26.4, 10.8, 10];
sp_HVC = [6, 4, 2, 2]; %age-dependent decrease in HVC ISI
...
% sp_rawPrun = [18.2, 30.9, 37.2, 23.1];
% sp_inh = [1, 1, 0.625, 0.625]; % age-dependent inhibition based on Sakaguchi 1996
