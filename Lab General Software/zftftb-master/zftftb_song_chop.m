...
% 				end
                ...
                trashDIR = 'C:\Users\Tim\Desktop\Song Data\Trash';
				if verLessThan('matlab','8')
					wavwrite(tmp,audio_fs,fullfile(trashDIR,[ export_file '.wav' ]));
				else
					audiowrite(fullfile(trashDIR,[ export_file '.wav']),tmp,audio_fs);
				end
