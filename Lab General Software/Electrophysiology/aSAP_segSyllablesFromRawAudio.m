function [syllStartTimes, syllEndTimes, noiseEst, noiseStd, soundEst, soundStd] = aSAP_segSyllablesFromRawAudio(audio, fs, thresh)
...
thresSyll = noiseEst + thresh * (disc - noiseEst);
